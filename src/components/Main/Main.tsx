...
const options = [
  ...
  { label: "только что отлетела", value: "только что отлетела" },
  {
  ...
  {
    label:
      "отправляется в расколбасное путешествие рейсом VK fest – полный улет",
    value:
      "отправляется в расколбасное путешествие рейсом VK fest – полный улет",
  },
